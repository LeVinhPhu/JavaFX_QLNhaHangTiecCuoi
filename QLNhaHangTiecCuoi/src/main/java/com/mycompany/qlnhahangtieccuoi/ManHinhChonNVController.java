...
public class ManHinhChonNVController implements Initializable {
    ...
    public void BtrHoaDon(ActionEvent event) throws IOException{
    ...
    public void BtrDangXuat(ActionEvent event) throws IOException{
        DangNhapController.cusID = 0;
        DangNhapController.emID = 0;
